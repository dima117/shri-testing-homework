...
describe('формирование страниц перед рендером', function () {
  describe('indexPage', function () {
    ...
    it('в объектах массива list есть свойство href', function () {
      // проверка
  ...
  describe('filesPage', function () {
    ...
    it('в объектах массива files есть свойство href', function () {
      // проверка
