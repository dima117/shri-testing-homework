const chai = require('chai'),
    expect = chai.expect;
const {buildBreadcrumbs: buildBreadcrumbsTest} = require('../../view/buildBreadcrumbs');

describe('buildBreadcrumbsTest', () => {

    it('should return an array', () => {

        let result = buildBreadcrumbsTest();
    ...
    it('should have 2 item while only hash provided', () => {
        ...
        let result = buildBreadcrumbsTest(testHash);
    ...
    it('should have 3 item while hash and path provided', () => {
        ...
        const testHash = 'testHash',
            testPath = 'testPath';
        let result = buildBreadcrumbsTest(testHash, testPath);
